// ======================================================================
// L05X01-PeriodMeasurement.v generated from TopDesign.cysch
// 02/15/2018 at 07:31
...
module top ;
	...
	cy_clock_v1_0
		#(.id("d4b0b005-0b9e-4026-a212-e3c35f1a6d57"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("38409994-c26a-424e-a517-6cd5c57cd4f6"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Captured_Input_net;
	wire [0:0] tmpIO_0__Captured_Input_net;
	wire [0:0] tmpINTERRUPT_0__Captured_Input_net;
	electrical [0:0] tmpSIOVREF__Captured_Input_net;

	cy_psoc3_pins_v1_10
		#(.id("c2d2fd33-e986-447c-8069-d98afdd039f8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Captured_Input
		 (.oe(tmpOE__Captured_Input_net),
		  .y({1'b0}),
		  .fb({Net_5}),
		  .io({tmpIO_0__Captured_Input_net[0:0]}),
		  .siovref(tmpSIOVREF__Captured_Input_net),
		  .interrupt({tmpINTERRUPT_0__Captured_Input_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Captured_Input_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Sq_Wave_Out_net;
	wire [0:0] tmpFB_0__Sq_Wave_Out_net;
	wire [0:0] tmpIO_0__Sq_Wave_Out_net;
	wire [0:0] tmpINTERRUPT_0__Sq_Wave_Out_net;
	electrical [0:0] tmpSIOVREF__Sq_Wave_Out_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Sq_Wave_Out
		 (.oe(tmpOE__Sq_Wave_Out_net),
		  .y({Net_51}),
		  .fb({tmpFB_0__Sq_Wave_Out_net[0:0]}),
		  .io({tmpIO_0__Sq_Wave_Out_net[0:0]}),
		  .siovref(tmpSIOVREF__Sq_Wave_Out_net),
		  .interrupt({tmpINTERRUPT_0__Sq_Wave_Out_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Sq_Wave_Out_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
