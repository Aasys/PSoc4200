...
module top ;
	...
	wire [0:0] tmpOE__PWM_Sig_net;
	wire [0:0] tmpFB_0__PWM_Sig_net;
	wire [0:0] tmpIO_0__PWM_Sig_net;
	wire [0:0] tmpINTERRUPT_0__PWM_Sig_net;
	electrical [0:0] tmpSIOVREF__PWM_Sig_net;
	...
	cy_psoc3_pins_v1_10
		...
		PWM_Sig
		 (.oe(tmpOE__PWM_Sig_net),
		  .y({Net_42}),
		  .fb({tmpFB_0__PWM_Sig_net[0:0]}),
		  .io({tmpIO_0__PWM_Sig_net[0:0]}),
		  .siovref(tmpSIOVREF__PWM_Sig_net),
		  .interrupt({tmpINTERRUPT_0__PWM_Sig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PWM_Sig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TC_Sig_net;
	wire [0:0] tmpFB_0__TC_Sig_net;
	wire [0:0] tmpIO_0__TC_Sig_net;
	wire [0:0] tmpINTERRUPT_0__TC_Sig_net;
	electrical [0:0] tmpSIOVREF__TC_Sig_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fcfd202c-6d14-4f85-b82f-0fbe07046574"),
		  ...
		  .input_buffer_sel(2'b00))
		TC_Sig
		 (.oe(tmpOE__TC_Sig_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TC_Sig_net[0:0]}),
		  .io({tmpIO_0__TC_Sig_net[0:0]}),
		  .siovref(tmpSIOVREF__TC_Sig_net),
		  .interrupt({tmpINTERRUPT_0__TC_Sig_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TC_Sig_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
