...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("fcfd202c-6d14-4f85-b82f-0fbe07046574"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("aae6f882-1496-4a0b-9a27-f4e72c270aaf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__CrossWalk_Button_net;
	wire [0:0] tmpFB_0__CrossWalk_Button_net;
	wire [0:0] tmpIO_0__CrossWalk_Button_net;
	electrical [0:0] tmpSIOVREF__CrossWalk_Button_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		CrossWalk_Button
		 (.oe(tmpOE__CrossWalk_Button_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CrossWalk_Button_net[0:0]}),
		  .io({tmpIO_0__CrossWalk_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__CrossWalk_Button_net),
		  .interrupt({Net_50}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__CrossWalk_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
