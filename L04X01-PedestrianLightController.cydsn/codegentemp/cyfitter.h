...
/* CrossWalk_Button */
#define CrossWalk_Button__0__DM__MASK 0xE00000u
#define CrossWalk_Button__0__DM__SHIFT 21u
#define CrossWalk_Button__0__DR CYREG_PRT0_DR
#define CrossWalk_Button__0__HSIOM CYREG_HSIOM_PORT_SEL0
#define CrossWalk_Button__0__HSIOM_MASK 0xF0000000u
#define CrossWalk_Button__0__HSIOM_SHIFT 28u
#define CrossWalk_Button__0__INTCFG CYREG_PRT0_INTCFG
#define CrossWalk_Button__0__INTSTAT CYREG_PRT0_INTSTAT
#define CrossWalk_Button__0__MASK 0x80u
#define CrossWalk_Button__0__PA__CFG0 CYREG_UDB_PA0_CFG0
#define CrossWalk_Button__0__PA__CFG1 CYREG_UDB_PA0_CFG1
#define CrossWalk_Button__0__PA__CFG10 CYREG_UDB_PA0_CFG10
#define CrossWalk_Button__0__PA__CFG11 CYREG_UDB_PA0_CFG11
#define CrossWalk_Button__0__PA__CFG12 CYREG_UDB_PA0_CFG12
#define CrossWalk_Button__0__PA__CFG13 CYREG_UDB_PA0_CFG13
#define CrossWalk_Button__0__PA__CFG14 CYREG_UDB_PA0_CFG14
#define CrossWalk_Button__0__PA__CFG2 CYREG_UDB_PA0_CFG2
#define CrossWalk_Button__0__PA__CFG3 CYREG_UDB_PA0_CFG3
#define CrossWalk_Button__0__PA__CFG4 CYREG_UDB_PA0_CFG4
#define CrossWalk_Button__0__PA__CFG5 CYREG_UDB_PA0_CFG5
#define CrossWalk_Button__0__PA__CFG6 CYREG_UDB_PA0_CFG6
#define CrossWalk_Button__0__PA__CFG7 CYREG_UDB_PA0_CFG7
#define CrossWalk_Button__0__PA__CFG8 CYREG_UDB_PA0_CFG8
#define CrossWalk_Button__0__PA__CFG9 CYREG_UDB_PA0_CFG9
#define CrossWalk_Button__0__PC CYREG_PRT0_PC
#define CrossWalk_Button__0__PC2 CYREG_PRT0_PC2
#define CrossWalk_Button__0__PORT 0u
#define CrossWalk_Button__0__PS CYREG_PRT0_PS
#define CrossWalk_Button__0__SHIFT 7u
#define CrossWalk_Button__DR CYREG_PRT0_DR
#define CrossWalk_Button__INTCFG CYREG_PRT0_INTCFG
#define CrossWalk_Button__INTSTAT CYREG_PRT0_INTSTAT
#define CrossWalk_Button__MASK 0x80u
#define CrossWalk_Button__PA__CFG0 CYREG_UDB_PA0_CFG0
#define CrossWalk_Button__PA__CFG1 CYREG_UDB_PA0_CFG1
#define CrossWalk_Button__PA__CFG10 CYREG_UDB_PA0_CFG10
#define CrossWalk_Button__PA__CFG11 CYREG_UDB_PA0_CFG11
#define CrossWalk_Button__PA__CFG12 CYREG_UDB_PA0_CFG12
#define CrossWalk_Button__PA__CFG13 CYREG_UDB_PA0_CFG13
#define CrossWalk_Button__PA__CFG14 CYREG_UDB_PA0_CFG14
#define CrossWalk_Button__PA__CFG2 CYREG_UDB_PA0_CFG2
#define CrossWalk_Button__PA__CFG3 CYREG_UDB_PA0_CFG3
#define CrossWalk_Button__PA__CFG4 CYREG_UDB_PA0_CFG4
#define CrossWalk_Button__PA__CFG5 CYREG_UDB_PA0_CFG5
#define CrossWalk_Button__PA__CFG6 CYREG_UDB_PA0_CFG6
#define CrossWalk_Button__PA__CFG7 CYREG_UDB_PA0_CFG7
#define CrossWalk_Button__PA__CFG8 CYREG_UDB_PA0_CFG8
#define CrossWalk_Button__PA__CFG9 CYREG_UDB_PA0_CFG9
#define CrossWalk_Button__PC CYREG_PRT0_PC
#define CrossWalk_Button__PC2 CYREG_PRT0_PC2
#define CrossWalk_Button__PORT 0u
#define CrossWalk_Button__PS CYREG_PRT0_PS
#define CrossWalk_Button__SHIFT 7u
#define CrossWalk_Button__SNAP CYREG_PRT0_INTSTAT
...
#define isr_btn__INTC_MASK 0x01u
#define isr_btn__INTC_NUMBER 0u
#define isr_btn__INTC_PRIOR_MASK 0xC0u
#define isr_btn__INTC_PRIOR_NUM 3u
...
/* my_PWM */
#define my_PWM_cy_m0s8_tcpwm_1__CC CYREG_TCPWM_CNT0_CC
#define my_PWM_cy_m0s8_tcpwm_1__CC_BUFF CYREG_TCPWM_CNT0_CC_BUFF
#define my_PWM_cy_m0s8_tcpwm_1__COUNTER CYREG_TCPWM_CNT0_COUNTER
#define my_PWM_cy_m0s8_tcpwm_1__CTRL CYREG_TCPWM_CNT0_CTRL
#define my_PWM_cy_m0s8_tcpwm_1__INTR CYREG_TCPWM_CNT0_INTR
#define my_PWM_cy_m0s8_tcpwm_1__INTR_MASK CYREG_TCPWM_CNT0_INTR_MASK
#define my_PWM_cy_m0s8_tcpwm_1__INTR_MASKED CYREG_TCPWM_CNT0_INTR_MASKED
#define my_PWM_cy_m0s8_tcpwm_1__INTR_SET CYREG_TCPWM_CNT0_INTR_SET
#define my_PWM_cy_m0s8_tcpwm_1__PERIOD CYREG_TCPWM_CNT0_PERIOD
#define my_PWM_cy_m0s8_tcpwm_1__PERIOD_BUFF CYREG_TCPWM_CNT0_PERIOD_BUFF
#define my_PWM_cy_m0s8_tcpwm_1__STATUS CYREG_TCPWM_CNT0_STATUS
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMD CYREG_TCPWM_CMD
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_MASK 0x01u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDCAPTURE_SHIFT 0u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_MASK 0x100u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDRELOAD_SHIFT 8u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_MASK 0x1000000u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDSTART_SHIFT 24u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_MASK 0x10000u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CMDSTOP_SHIFT 16u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CTRL CYREG_TCPWM_CTRL
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CTRL_MASK 0x01u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_CTRL_SHIFT 0u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE CYREG_TCPWM_INTR_CAUSE
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_MASK 0x01u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_INTR_CAUSE_SHIFT 0u
#define my_PWM_cy_m0s8_tcpwm_1__TCPWM_NUMBER 0u
#define my_PWM_cy_m0s8_tcpwm_1__TR_CTRL0 CYREG_TCPWM_CNT0_TR_CTRL0
#define my_PWM_cy_m0s8_tcpwm_1__TR_CTRL1 CYREG_TCPWM_CNT0_TR_CTRL1
#define my_PWM_cy_m0s8_tcpwm_1__TR_CTRL2 CYREG_TCPWM_CNT0_TR_CTRL2

/* my_isr */
#define my_isr__INTC_CLR_EN_REG CYREG_CM0_ICER
#define my_isr__INTC_CLR_PD_REG CYREG_CM0_ICPR
#define my_isr__INTC_MASK 0x10000u
#define my_isr__INTC_NUMBER 16u
#define my_isr__INTC_PRIOR_MASK 0xC0u
#define my_isr__INTC_PRIOR_NUM 3u
#define my_isr__INTC_PRIOR_REG CYREG_CM0_IPR4
#define my_isr__INTC_SET_EN_REG CYREG_CM0_ISER
#define my_isr__INTC_SET_PD_REG CYREG_CM0_ISPR
